...
def get_bug_catching_tests(test_corpus_dir):

    df = pd.read_csv(f'{test_corpus_dir}/test_data.csv')
    datapath = f'{test_corpus_dir}/results/bug_detection_log/'
    ...
    return bug_catching_tests


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('test_corpus_dir')
    test_corpus_dir = parser.parse_args().test_corpus_dir

    bug_catching_tests = get_bug_catching_tests(test_corpus_dir)
    ...
    bug_catching_tests.to_csv(f'{test_corpus_dir}/bug_catching_tests.csv')
